...
namespace Wbm\TagManagerAnalytics\Subscriber\CartAddPrice;
...
class AfterLineItemAddedSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(SessionFactoryInterface $session, EntityRepository $productRepository)
    {
